...
def menu():
    ...
    print(garis)
    print((k+"["+p+"•"+k+"]"+p+" Your ID : "+m+id))
    print((k+"["+p+"•"+k+"]"+p+" Your IP : "+ip))
    print((k+"["+p+"•"+k+"]"+p+" Status  : "+o+"Premium"+p))
...
def pilihcrack(file):
  print((k+"\n["+p+"1"+k+"]"+p+" Api ("+k+"Proses Cepat"+p+")"))
  print((k+"["+p+"2"+k+"]"+p+" Api + TTL ("+k+"Proses Cepat"+p+")"))
  print((k+"["+p+"3"+k+"]"+p+" Mbasic ("+k+"Proses Agak Lambat"+p+")"))
  print((k+"["+p+"4"+k+"]"+p+" Mbasic + TTL ("+k+"Peoses Lambat"+p+")"))
  print((k+"["+p+"5"+k+"]"+p+" Free Facebook ("+k+"Proses Sangat Lambat"+p+")"))
  krah=input(k+"\n["+p+"•"+k+"]"+p+" Pilih : ")
  if krah in[""]:
    print((k+"["+p+"!"+k+"]"+p+" Fill In The Correct"))
    pilihcrack(file)
